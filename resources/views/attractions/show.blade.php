...
@section('breadcrumbs')
    <li><a href="{{ route('attractions.index') }}">Tours</a></li>
    <li>{{ $model->getName() }}</li>
@endsection

@section('content')
    <div class="row">
        <div class="col-md-8" id="single_attraction_desc">
            <div id="single_attraction_feat">
                <ul>
            ...
            <?php $coord = explode(',', $nst['boundary']) ?>
                {
                    ...
                    url_point: '{{ route('attractions.show', explode('$', $nst['productId'])[0]) }}'
                },
            @endforeach
            ]
        };
